...
| 2 | View HomeView | See cards | See cards | **A003 shows "⚠️ Còn lại: 3 phút"** (red text) |
...
- Time label changes from "⚠️ Còn lại: 2 phút" → "⏱ Còn lại: 7 phút"
...
│ 5,000,000,000 VNĐ       │
│ ⚠️ Còn lại: 3 phút      │  ← RED (Anti-snipe warning)
│ [Đang mở] [Đấu giá]     │
└─────────────────────────┘
```
